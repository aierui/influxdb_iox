...
use query::{
    exec::stringset::StringSet, util::df_physical_expr_from_schema_and_expr, QueryChunk,
    QueryChunkMeta,
};
    ...
    fn read_filter(
        ...
        if let Some(mut batch) = batch {
            ...
            if let Some(filter_expr) = predicate.filter_expr() {
                ...
                let mut rewriter = query::frontend::influxrpc::MissingColumnsToNull::new(&schema);
